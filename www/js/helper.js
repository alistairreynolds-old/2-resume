...
var HTMLemail = '<li class="flex-item"><span class="blue-text">email</span><span ><a href="mailto:%data%">%data%</a></span></li>';
var HTMLtwitter = '<li class="flex-item"><span class="blue-text">twitter</span><span >%data%</span></li>';
var HTMLgithub = '<li class="flex-item"><span class="blue-text">github</span><span ><a href="http://www.github.com/%data%" target="_blank">%data%</span></li>';
...
$(document).ready(function() {
  $('button').click(function() {
    var iName = inName("alistair reynolds") || function(){};
    $('#name').html(iName);
  });
});
...
function inName(name){
  ...
  aryName[1] = aryName[1].toUpperCase();
  var n = aryName[0].substr(0,1);
  aryName[0] = n.toUpperCase() + aryName[0].substr(1);
